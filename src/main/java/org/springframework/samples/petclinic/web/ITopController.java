...
public class ITopController {
	...
	public String ITopControllerGet(Map<String, Object> model) {
		...
		final String uri =  "http://itop-9f5df6.appfleet.net/webservices/rest.php?version=1.3&json_data={ \"operation\": \"core/get\", \"class\": \"Person\", \"key\": \"SELECT Person WHERE email LIKE '%'\", \"output_fields\": \"friendlyname, email,phone\" }";
